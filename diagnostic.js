...
try {
  ...
  console.error('[DIAGNOSTIC] ✗ Failed to import StdioServerTransport:', error.message);
}
...
console.error('[DIAGNOSTIC] All basic imports completed. Server should be able to start.');
