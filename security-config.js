...
export const SECURITY_CONFIG = {
  // Input size limits
  MAX_TEMPLATE_NAME_LENGTH: parseInt(process.env.MAX_TEMPLATE_NAME_LENGTH) || 100,
  MAX_DESCRIPTION_LENGTH: parseInt(process.env.MAX_DESCRIPTION_LENGTH) || 500,
  MAX_INSTRUCTIONS_LENGTH: parseInt(process.env.MAX_INSTRUCTIONS_LENGTH) || 2000,
  MAX_EXPECTATIONS_LENGTH: parseInt(process.env.MAX_EXPECTATIONS_LENGTH) || 1000,
  ...
  MAX_INDIVIDUAL_FIELD_SIZE: parseInt(process.env.MAX_INDIVIDUAL_FIELD_SIZE) || 2000,
  ...
  // Security features
  ENABLE_DEBUG_LOGGING: process.env.DEBUG === 'true' || process.env.NODE_ENV === 'development',
  ...
  MAX_HEALTHY_RESPONSE_TIME_MS: parseInt(process.env.MAX_HEALTHY_RESPONSE_TIME_MS) || 5000,
...
export function validateSecurityLimits() {
  ...
  if (SECURITY_CONFIG.ENABLE_ERROR_DETAILS && process.env.NODE_ENV === 'production') {
